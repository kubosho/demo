import { nativeSendBeacon } from "../beacons/native_send_beacon.mjs";
import {
  BEFORE_UNLOAD_EVENT,
  PAGEHIDE_EVENT,
  UNLOAD_EVENT,
...
window.onbeforeunload = (_event) => {
  nativeSendBeacon({ origin: ORIGIN, event: BEFORE_UNLOAD_EVENT });
};
...
window.addEventListener(UNLOAD_EVENT, (_event) => {
  nativeSendBeacon({ origin: ORIGIN, event: UNLOAD_EVENT });
});
